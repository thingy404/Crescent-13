...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("wooddooropen")
				soundin = pick('sound/effects/dooropen1.ogg','sound/effects/dooropen2.ogg')
			if ("wooddoorclose")
				soundin = pick('sound/effects/doorclose1.ogg','sound/effects/doorclose2.ogg')
			if ("doorknock")
				soundin = pick('sound/effects/door_knock1.ogg','sound/effects/door_knock2.ogg','sound/effects/door_knock3.ogg','sound/effects/door_knock4.ogg')
			if ("doorbang")
				soundin = pick('sound/effects/door_bang1.ogg','sound/effects/door_bang2.ogg','sound/effects/door_bang3.ogg')
			if ("wooddoordamage")
				soundin = pick('sound/effects/Doordam1.ogg','sound/effects/Doordam2.ogg','sound/effects/Doordam3.ogg','sound/effects/Doordam4.ogg','sound/effects/Doordam5.ogg','sound/effects/Doordam6.ogg')
			if ("button")
